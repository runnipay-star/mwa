...
import { Clock, Book, BarChart, Check, Lock, Play, PlayCircle, Sparkles, AlertCircle, ShoppingCart } from 'lucide-react';
                    ...
                    <div className="p-8">
                        ...
                        {isPurchased ? (
                            ...
                            <div className="space-y-3">
                                {!user && course.discounted_price && (
                                    <div className="mb-4 p-3 bg-blue-50 text-blue-800 text-xs rounded-lg flex items-start border border-blue-100">
                                        <AlertCircle className="h-4 w-4 mr-2 flex-shrink-0 mt-0.5" />
                                        <span>
                                            Hai già acquistato in passato? <a href="#/login" className="font-bold underline">Accedi</a> per vedere se hai diritto a uno sconto fedeltà.
                                        </span>
                                    </div>
                                )}
                                ...
                                <button 
                                    onClick={onPurchase}
                                    className="w-full bg-brand-600 text-white py-4 rounded-xl font-bold text-lg hover:bg-brand-700 transition-all shadow-lg shadow-brand-500/30 mb-4"
                                >
                                    Acquista Ora
                                </button>
                            </div>
                        ...
                        <p className="text-center text-xs text-gray-400 mb-6">
                            {isPurchased ? 'Accesso completo sbloccato.' : 'Pagamento sicuro via Stripe. Accesso immediato.'}
                        </p>
